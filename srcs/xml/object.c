...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/03/04 16:11:49 by yoouali           #+#    #+#             */
/*   Updated: 2021/03/04 16:19:27 by yoouali          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		get_object_data3(t_xmlpar *xmlpar, int rule_num, t_vec3 vec3)
{
	t_object	*object;
...
int		get_object_data2(t_xmlpar *xmlpar, int rule_num, char *str, t_vec3 vec3)
{
	t_object	*object;
	...
	return (get_object_data3(xmlpar, rule_num, vec3));
}
...
int		get_object_data(t_xmlpar *xmlpar, int rule_num, char *str)
{
	...
	return (get_object_data2(xmlpar, rule_num, str, vec3));
}
