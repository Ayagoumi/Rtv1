...
int		check_rule_pos(int rule, int parent)
{
	...
	if (parent == 3 && rule != 10 && rule != 12 && rule != 11)
		return (0);
	if (parent == 4 && rule != 11 && rule != 10 && rule != 13\
			&& rule != 16 && rule != 17)
		return (0);
	if (parent == 5 && rule != 11 && rule != 10 && rule != 15\
			&& rule != 16 && rule != 17)
		return (0);
	if (parent == 6 && rule != 10 && rule != 11 && rule != 13\
			&& rule != 15 && rule != 16 && rule != 17)
		return (0);
	if (parent == 7 && rule != 11 && rule != 10 && rule != 13\
			&& rule != 14 && rule != 16 && rule != 17)
		return (0);
	return (1);
}
