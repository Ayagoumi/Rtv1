...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/03/05 18:02:38 by ayagoumi          #+#    #+#             */
/*   Updated: 2021/03/05 18:46:43 by ayagoumi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				parrs_rule(t_xmlpar *xmlpar, char **rule,\
				int *rule_num, int parent);
...
int				get_rule(t_xmlpar *xmlpar, char **rule,\
				int *rule_num, int parent);
